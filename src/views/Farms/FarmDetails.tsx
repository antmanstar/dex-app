...
export const FarmDetails: React.FC<IFarmDetails> = (props: IFarmDetails) => {
  ...
  const renderButtons = () => {
    if (!account) {
      return (
        <StyledSingleRow justifyContent="center">
    ...
    return (
      <StyledSingleRow justifyContent="center" flexDirection="column">
        <Flex justifyContent="space-evenly" mb="24px">
          ...
          <Button onClick={() => dispatch(setActiveBodyType("unstake"))}>
            {t("Unstake")}
          </Button>
        </Flex>
        <Flex justifyContent="center">
          <Button onClick={() => dispatch(setActiveBodyType("claim"))}>
            {t("Claim")}
          </Button>
        </Flex>
      </StyledSingleRow>
